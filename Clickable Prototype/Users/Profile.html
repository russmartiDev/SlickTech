...
<html lang="en">
	<head>
		...
		<!-- main style -->
		<link rel="stylesheet/less" type="text/css" href="../Assets/style/profile.less" />
		 ...
		 <nav class="container">
			<div class="row w-100 align-items-center p-2 top-nav navbar fixed-top">
				...
				<div class="col-auto col-lg-1 text-center">
					<a href="../products/home.html" class="text-light w-100">HOME</a>
				</div>
	
				<div class="col-auto col-lg-1 text-center">
					<a href="../products/all_products.html" class="text-light w-100">PRODUCTS</a>
				</div>
				...
				<div class="col-auto col-lg-1 text-center align-items-center dropdown">
					...
					<li><a class="dropdown-item" href="Profile.html"><i class="fas fa-user-alt"></i>Edit Profile</button></a></li>
				...
				<div class="col-auto col-lg-1 mt-1 text-center">
					<a href="../products/cart.html" class="text-light w-100 cart"><i class="fas fa-shopping-cart"></i><div class="cart-count ">12</div></a>
				</div>
	
			</div>
		</nav>

		<h1 class="text-light"><i class="fas fa-user"></i> Profile</h1>
		<div class="container text-light">
			<div class="row gx-5">
				<div class="col-12 col-lg-6">
					...
					<div class="pay">
						<input type="button" class="btn btn-primary mt-3" value="Change Password" />
					</div>

					<div class="pay">
						<input type="button" class="btn btn-success mt-5" value="Save" />
					</div>
				</div>
				<div class="col-12 col-lg-6">
					...
					<div class="pay">
						<input type="button" class="btn btn-success mt-4" value="Save" />
					</div>
